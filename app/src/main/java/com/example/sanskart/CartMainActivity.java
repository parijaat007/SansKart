...
import com.example.sanskart.Model.CartInfo;
import com.example.sanskart.Model.CartItem;
import com.example.sanskart.ViewHolder.CartItemsAdapter;
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        mCartRef.child("Info").addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                intent.putExtra("cartTotal", cartInfo.getCartTotal() );
...
//                                mDiscount.setText("Regular Customer Discount : "+discount+"%");
                                ...
                                cartInfo.put("CartItemsTotal",String.valueOf(finalCartTotal));
                                cartInfo.put("Discount",String.valueOf(discount));
                                cartInfo.put("CartTotal",String.valueOf(TotalPrice));
...
//                mCartTotal.setText("Total Amount : "+ cartTotal);
            }
